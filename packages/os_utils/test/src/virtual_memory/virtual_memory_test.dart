...
void main() {
  group('VirtualMemory:', () {
    ...
    Future<ProcessResult> runVirtualMemoryScript(String when, int protection, String op) async {
      final future = Process.run(
        'dart',
        [
          'test/src/virtual_memory/virtual_memory_error_script.dart'.replaceAll('/', Platform.pathSeparator),
          when,
          protection.toString(),
          op,
        ],
    ...
    test('allocate(..., protection:VirtualMemory.protectionNoAccess)', () async {
    ...
    test('allocate(..., protection:VirtualMemory.protectionReadWrite)', () async {
