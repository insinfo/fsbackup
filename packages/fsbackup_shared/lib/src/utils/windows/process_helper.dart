...
import 'package:fsbackup_shared/src/utils/process_helper.dart';
import 'package:fsbackup_shared/src/utils/with_memory.dart';
      ...
      withMemory<void, Uint32>(sizeOf<Uint32>(), (phMod) {
        withMemory<void, Uint32>(sizeOf<Uint32>(), (pcbNeeded) {
          if (EnumProcessModules(hProcess, phMod.cast(), sizeOf<Uint32>(), pcbNeeded) == 1) {
            withMemory<void, Utf16>(MAX_PATH * sizeOf<Uint16>(), (pszProcessName) {
              GetModuleBaseName(hProcess, phMod.value, pszProcessName, MAX_PATH);
