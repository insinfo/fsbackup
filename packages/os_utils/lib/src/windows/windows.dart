...
final virtualAlloc = libraryLoader.open().lookupFunction<_virtualAlloc_C, _virtualAlloc_Dart>(
      'VirtualAlloc',
    );

final virtualFree = libraryLoader.open().lookupFunction<_virtualFree_C, _virtualFree_Dart>(
      'VirtualFree',
    );

final virtualProtect = libraryLoader.open().lookupFunction<_virtualProtect_C, _virtualProtect_Dart>(
      'VirtualProtect',
    );
