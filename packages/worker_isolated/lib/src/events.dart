...
class TaskScheduledEvent extends WorkerEvent {
  ...
  TaskScheduledEvent(WorkerIsolate isolate, this.task) : super('taskScheduled', isolate);
}
...
class TaskCompletedEvent extends WorkerEvent {
  ...
  TaskCompletedEvent(WorkerIsolate isolate, this.task, this.result) : super('taskCompleted', isolate);
}
...
class TaskFailedEvent extends WorkerEvent {
  ...
  TaskFailedEvent(WorkerIsolate isolate, this.task, this.error, [this.stackTrace]) : super('taskFailed', isolate);
}
